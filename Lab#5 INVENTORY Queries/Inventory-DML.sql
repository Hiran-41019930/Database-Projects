...
echo "# Database-Projects" >> README.md
git init
git add README.md
git commit -m "first commit"
git branch -M main
git remote add origin https://github.com/Hiran-41019930/Database-Projects.git
git push -u origin main


INSERT INTO Customer_T VALUES ('C001', 'Hiran', 'Samarasinghe', '613-727-4723', '1385 Woodroffe Ave', 'Ottawa'   ,'ON','K2G1V8', 90);
INSERT INTO Customer_T VALUES ('C002', 'Pasan', 'Samarasinghe', '613-727-4724','185 Woodroffe Ave', 'Toronto'   ,'ON','K2G1V8', 1);
INSERT INTO Customer_T VALUES ('C003', 'Kamal', 'Perera', '613-727-4725','1385 Woodroffe Ave', 'Ottawa'   ,'ON','K2G1V8', 0);
INSERT INTO Customer_T VALUES ('C004', 'James', 'Bond', '613-727-4726', 'Street' , 'Toronto'  ,'ON','K2G1V8', 0);
INSERT INTO Customer_T VALUES ('C005', 'Diana', 'Jackson', '613-727-4729','264 Main Street'   , 'Kitchener','ON','K2G1V8', 0);
INSERT INTO Customer_T VALUES ('C006', 'Joe', 'Taylor','613-727-4721','57 Rue Catherine' , 'Montreal' ,'ON','K2G1V8', 0);
